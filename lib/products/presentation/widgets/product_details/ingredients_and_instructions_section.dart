...
class IngredientsAndInstructionsSection extends StatefulWidget {
  ...
  const IngredientsAndInstructionsSection({super.key, required this.item});
...
class _IngredientsAndInstructionsSectionState
  ...
  late final _tabs = <({Widget body, String title})>[
    (
      title: 'Ingredients',
      body: IngredientsSection(ingredients: widget.item.ingredients),
    ),
    (title: 'Instructions', body: StepsSection(steps: widget.item.steps)),
  ];
