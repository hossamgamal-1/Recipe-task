...
class IngredientEntity {
  ...
  const IngredientEntity({required this.quantity, required this.isFeatured, required this.product});
}
...
class StepEntity {
  ...
  const StepEntity({required this.id, required this.stepNum, this.description, this.image});
}
